    ...
    <Document>
      <Page size="A4" style={styles.page}>
        ...
        <View style={styles.section}>
          ...
          <View style={styles.article}>
            <Text style={styles.articleContent}>
              ...
              2. 디자인(인쇄물) 제작 완료 후 해지 시: 납입 금액의 40% 환불 (인쇄물 제작 완료 후, 홈페이지 제작 중 해지 시 홈페이지 제작은 중단됩니다.){'\n'}
        ...
        <View style={styles.section}>
          ...
          <View style={styles.article}>
            <Text style={styles.articleContent}>
              1. 웹사이트 제작 서비스를 이용하는 경우, {isPromotion ? '계약일로부터 2년간' : '계약일로부터 1년간'} 도메인 및 호스팅이 무료로 제공된다.{'\n'}
              2. 호스팅 트래픽이 월 100GB를 초과하는 경우, 초과 트래픽에 대해 별도 비용이 청구될 수 있다. (계약 기간 중에도 동일하게 적용) 단, 트래픽 기본 사용량 정책은 서비스 제공사(Vercel)의 정책에 따라 변동될 수 있다.{'\n'}
              3. Meta 광고 연동 서비스(광고 자동화, 알림, 대시보드 등)는 {isPromotion ? '계약일로부터 2년간' : '계약일로부터 1년간'} 무료로 제공된다. 단, 광고 소재 제작은 포함되지 않는다.{'\n'}
              4. Meta 광고 연동 서비스 무료 기간 종료 후 계속 이용 시 200,000원/월 (부가세 별도), 3개월 단위 결제가 필요하다.{'\n'}
              5. 유지비용 미납 시 서비스가 중단될 수 있으며, 중단 후 30일 경과 시 데이터가 삭제될 수 있다.{'\n'}
              6. 갑은 계약 종료 전 데이터 백업을 요청할 수 있으며, 을은 합리적인 범위 내에서 협조한다.
            </Text>
          </View>
        </View>
