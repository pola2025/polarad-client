    ...
    try {
      for (const file of Array.from(files)) {
        ...
        if (file.size > 10 * 1024 * 1024) {
          setMessage({ type: "error", text: `${file.name}: 파일 크기는 10MB를 초과할 수 없습니다` });
          continue;
        }

        const formDataUpload = new FormData();
        formDataUpload.append("file", file);
        formDataUpload.append("fileType", "communication");
        ...
        >
          ...
          <div>
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-xs text-gray-500">jpg, png, pdf (최대 10MB)</span>
            </div>
            {/* 첨부된 파일 목록 */}
